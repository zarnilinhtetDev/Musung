        ...
        if (typeof options == "string") {
            ...
            if (!nmpd)
                throw (
                    "Cannot perform '" +
                    options +
                    "' on a numpad prior to initialization!"
                );
            switch (options) {
                case "open":
                    nmpd.open(
                        nmpd.options.target ? nmpd.options.target : this.first()
                    );
                    break;
                case "close":
                    nmpd.open(
        ...
        return this.each(function () {
            ...
            if ($("#" + id).length == 0) {
                ...
                table.append(
                    $(options.rowTpl).append(
                        $(options.displayCellTpl)
                            ...
                            .append(
                                $(
                                    '<input type="hidden" class="dirty" value="0"></input>'
                                )
                            )
                    )
                );
                ...
                $("#" + id + " .numero").bind("click", function () {
                    ...
                    if ($("#" + id + " .dirty").val() == "0") {
                        ...
                        val = nmpd.getValue()
                            ? nmpd.getValue().toString() + $(this).text()
                            : $(this).text();
                    }
                    nmpd.setValue(val);
                });
            ...
            nmpd.setValue = function (value) {
                if (nmpd.display.attr("maxLength") < value.toString().length)
                    value = value
                        .toString()
                        .substr(0, nmpd.display.attr("maxLength"));
