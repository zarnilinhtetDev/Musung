...
@section('content_2')
    ...
    @superadmin
        <div class="container-fluid">
            ...
            <h1 class="fw-bold heading-text">Change Report Data</h1>
            <div class="row g-3">
            ...
            <div class="col-12 col-md-4 my-3 p-0">
                <ul class="horizontal-slide" id="tabs">
                    ...
                    PDF</button> --}}
                        <button type="button" onclick="javascript:demoFromHTML();"
                            class=" icon-btn-one icon-btn-one-2 btn
                    ...
                    <div style="overflow-x:auto;max-width:100%;" id="table1">
                        <table class="table table-striped my-4 tableFixHead results p-0 text-center table-bordered"
                            ...
                            <tbody id="myTable" class="report_tbl_2">
                                @for ($i = 0; $i < count($daily_report_decode); $i++)
                                    @php
                                        $l_id = $daily_report_decode[$i]['l_id'];
                                        $l_name = $daily_report_decode[$i]['l_name'];
                                        $main_target = $daily_report_decode[$i]['main_target'];
                                        $ot_main_target = $daily_report_decode[$i]['ot_main_target'];
                                        $actual_target = $daily_report_decode[$i]['total_div_actual_target'];
                                        $m_power = $daily_report_decode[$i]['m_power'];
                                        $actual_m_power = $daily_report_decode[$i]['actual_m_power'];
                                        $hp = $daily_report_decode[$i]['hp'];
                                        $actual_hp = $daily_report_decode[$i]['actual_hp'];
                                    ...
                                    $remark = $daily_report_decode[$i]['remark']; @endphp <tr>
                                        ...
                                        <td class="td-padding">
                                            <table class="m-auto text-center table table-bordered custom-table-border-color">
                                                <tbody>
                                                    ...
                                                    @for ($j = 0; $j < count($daily_report_product_decode); $j++)
                                                        @php
                                        ...
                                        <td class="main_target_{{ $l_id }}">
                                            {{ number_format($main_target + $ot_main_target) }}
                                        </td>
                                            ...
                                            <table class="m-auto text-center table table-bordered custom-table-border-color">
                                                @if ($edit_status)
                                                    <tbody class="man_power_input">
                                                        <input type="hidden" id="man_target_l_id_input"
                                                            name="man_target_l_id[]" value="<?php echo $l_id; ?>" />
                                                        <input type="hidden" id="man_target_a_id_input"
                                                            name="man_target_a_id[]" value="<?php echo $assign_id_2; ?>" />
                                                        <input type="hidden" id="man_target_date_input" name="date_input[]"
                                                            value="<?php echo $date; ?>" />
                                                        @for ($j = 0; $j < count($daily_report_product_2_decode); $j++)
                                                            @php
                                                            ...
                                                            @endphp @if ($l_id_2 == $l_id)
                                                                <tr>
                                                                    <td>
                                                                        <input type="number" id="man_target"
                                                                            class="form-control p-0 text-center"
                                                                            name="man_target[]" placeholder="0" min="0"
                                                                            step="any" value="<?php echo $man_target_2; ?>">
                                                                    </td>
                                                                    <td>
                                                                        <input type="number" id="man_actual_target"
                                                                            class="form-control p-0 text-center"
                                                                            name="man_actual_target[]" placeholder="0"
                                                                            min="0" step="any"
                                        ...
                                        <td class="actual_target_{{ $l_id }}">
                                            @if ($actual_target != '')
                                                {{ number_format($actual_target) }}
                                            @endif
                                        </td>
                                                            ...
                                                            @if ($l_id_2 == $l_id)
                                                                <tr>
                                                                    <td class="order_quantity_input">
                                                                        <input type="hidden" id="order_l_id_input"
                                                                            name="l_id[]" value="<?php echo $l_id; ?>" />
                                                                        <input type="hidden" id="order_a_id_input"
                                                                            name="a_id[]" value="<?php echo $assign_id_2; ?>" />
                                                                        <input type="hidden" id="order_date_input"
                                                                            name="date_input[]"
                                                                            value="<?php echo $date; ?>" />
                                                                        <input type="number" id="order_val_input"
                                                                            class="form-control p-0 text-center"
                                                                            name="order_val_input[]" placeholder="0"
                                                                            min="0" step="any"
                                                                            value="<?php echo $order_qty; ?>">
                                                                        <input type="hidden" id="order_p_id_input"
                                                                            name="p_id_input[]"
                                                            ...
                                                            @if ($l_id_2 == $l_id)
                                                                <tr>
                                                                    <td class="sewing_input">
                                                                        <input type="hidden" id="sewing_l_id_input"
                                                                            name="l_id[]" value="<?php echo $l_id; ?>" />
                                                                        <input type="hidden" id="sewing_a_id_input"
                                                                            name="a_id[]" value="<?php echo $assign_id_2; ?>" />
                                                                        <input type="hidden" id="sewing_date_input"
                                                                            name="date_input[]"
                                                                            value="<?php echo $date; ?>" />
                                                                        <input type="number" id="sewing_val_input"
                                                                            class="form-control p-0 text-center"
                                                                            name="sewing_input[]" placeholder="0"
                                                                            min="0" step="any"
                                                                            value="<?php echo $sewing_input; ?>">
                                                                        <input type="hidden" id="sewing_p_id_input"
                                                                            name="p_id_input[]"
                                                                            value="<?php echo $p_id_2; ?>" />
                                                                    </td>
                                                                </tr>
                                                    ...
                                                    @for ($j = 0; $j < count($daily_report_product_decode); $j++)
                                                        ...
                                                        @endphp @if ($l_id_2 == $l_id)
                                                            <tr>
                                                                ...
                                                                @endif
                                                                @if ($cat_actual_target != '')
                                                                    <td class="new_cat_actual_target">
                                                                        {{ number_format($cat_actual_target) }}
                                                                    </td>
                                                                @endif
                                                            </tr>
                                                        @endif
                                                                ...
                                                                @if ($edit_status)
                                                                    <td class="td_input">
                                                                        ...
                                                                        <input type="hidden" id="p_id_input" name="p_id[]"
                                                                            value="<?php echo $p_id_2; ?>" />
                                                                        <input type="number" id="cmp_input"
                                                                            class="form-control p-0 text-center"
                                                                            name="cmp[]" placeholder="0" min="0"
                                                                            step="any" value="<?php echo $cmp; ?>" />
                                            ...
                                            $p_id_2 = $daily_report_product_decode[$j]['p_detail_id']; @endphp @if ($l_id_2 == $l_id)
                                                <tr>
                                                    <td class="inline_input">
                                                        ...
                                                        <input type="hidden" id="inline_p_id_input"
                                                            name="inline_p_id_input[]" value="<?php echo $p_id_2; ?>" />
                                                ...
                                                <tr>
                                                    <td class="h_over_input">
                                                        ...
                                                        <input type="hidden" id="handover_date_input" name="date_input[]"
                                                            value="<?php echo $date; ?>" />
                                                        <input type="number" id="handover_val_input"
                                                            class="form-control p-0 text-center" name="handover_val_input[]"
                            ...
                            <table class="m-auto text-center w-100 table table-bordered custom-table-border-color">
                                @if ($edit_status)
                                    <tbody class="m_power_input_2">
                                        <input type="hidden" id="m_power_l_id_input_2" name="l_id[]"
                                            value="<?php echo $l_id; ?>" />
                                        ...
                                        <tr>
                                            <td>
                                                <input type="number" id="m_power_value_2"
                                                    class="form-control p-0 text-center" name="m_power_value_2[]"
                                                    placeholder="0" min="0" step="any"
                                        ...
                                        <tr>
                                            <td>
                                                <input type="number" id="actual_m_power_value_2"
                                                    ...
                                                    placeholder="0" min="0" step="any"
                                                    value="<?php echo $actual_m_power; ?>">
                                            </td>
                                            <td>
                                                <input type="number" id="actual_hp_value_2"
                                                    class="form-control p-0 text-center" name="actual_hp_value_2[]"
                                                    placeholder="0" min="0" step="any"
                        ...
                        @for ($k = 0; $k < count($daily_report_decode); $k++)
                            @php$l_id_2 = $daily_report_decode[$k]['l_id'];
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        $total_time = (int) $daily_report_decode[$k]['total_time']; @endphp ?> ?> ?> ?> ?> ?> ?> ?> ?> ?> ?> ?> ?> ?> ?> ?> ?> ?> ?> ?> ?> ?> ?> ?> ?> ?> ?> ?>
                            ?>
                            ?>
                            ?>
                            ?>
                            ...
                            ?>
                            @if ($l_id_2 == $l_id)
                                <td class="total_time_{{ $l_id_2 }}"> {{ $total_time }} </td>
                            @endif
                        @endfor
                        ...
                        <td class="note_input">
                            @if ($edit_status)
                                ...
                                <input type="hidden" id="note_date_input" name="date_input[]"
                                    value="<?php echo $date; ?>" />
                                <textarea class="form-control note" name="note[]" placeholder="Note" id="note_val_input" maxlength="150"><?php echo $remark; ?></textarea>
                            @else
                                {{ $remark }}
                            @endif
                        </td>
    ...
    @owner
        <div class="container-fluid">
            ...
            <div id="today_report">
                @if (!$edit_status)
                    <a class='btn custom-btn-theme custom-btn-theme-edit text-white'
                        href="{{ url('/report') }}?edit=1">Edit</a>
                @endif
                            ...
                            <tbody id="myTable" class="report_tbl_2">
                                @for ($i = 0; $i < count($daily_report_decode); $i++)
                                    @php
                                        ...
                                        $man_actual_target = $daily_report_product_decode[$i]['man_actual_target'];
                                        $assign_id_2 = $daily_report_decode[$i]['assign_id'];
                                        $remark = $daily_report_decode[$i]['remark'];
                                    @endphp <tr>
                                        <td>{{ $l_name }}</td>
    ...
    @admin
        <div class="container-fluid">
            ...
            <h1 class="fw-bold heading-text">Report Data</h1>
            <div class="row g-3">
                <div class="col-12 col-md-4">
                    <label for="date">Select Date</label>
                    <input type="date" class="form-control" id="date" />
            ...
            <div id="today_report">
                ...
                <form method="POST" id="cmp_put">
                    ...
                    <div style="" id="report_table" class="text-center">
                            ...
                            <tbody id="myTable" class="report_tbl_2">
                                @for ($i = 0; $i < count($daily_report_decode); $i++)
                                    @php
                                        ...
                                        $man_actual_target = $daily_report_decode[$i]['man_actual_target'];
                                        $assign_id_2 = $daily_report_decode[$i]['assign_id'];
                                    $remark = $daily_report_decode[$i]['remark']; @endphp <tr>
                                        <td>{{ $l_name }}</td>
                                                        ...
                                                        @for ($j = 0; $j < count($daily_report_product_2_decode); $j++)
                                                            ...
                                                            @endphp @if ($l_id_2 == $l_id)
                                                                <tr>
                                                                    ...
                                                                    <td class="new_man_actual_target">
                                                                        {{ $man_actual_target_2 }}</td>
                                                                </tr>
                                                            @endif
                                                        @endfor
                                                    </tbody>
                                                            ...
                                                            <tr>
                                                                <td class="sewing_input">
                                                                    ...
                                                                    <input type="hidden" id="sewing_a_id_input"
                                                                        name="a_id[]" value="<?php echo $assign_id_2; ?>" />
                                                                    <input type="hidden" id="sewing_date_input"
                                                                        name="date_input[]" value="<?php echo $date; ?>" />
                                                                    <input type="number" id="sewing_val_input"
                                                                        class="form-control p-0 text-center"
                                                                        name="sewing_input[]" placeholder="0" min="0"
                                                                        step="any" value="<?php echo $sewing_input; ?>">
                                                                    <input type="hidden" id="sewing_p_id_input"
                                                                        name="p_id_input[]" value="<?php echo $p_id_2; ?>" />



                                                                </td>
                                                            </tr>
                                                            {{-- <input type="hidden" id="sewing_p_id_input" name="cat_actual_target"
                                                                value="{{ $test }}" /> --}}
                                                        @endif
                                                    @endfor
                                                </tbody>
                                                ...
                                                @if ($edit_status)
                                                    <td class="td_input">
                                                        ...
                                                        <input type="hidden" id="p_id_input" name="p_id[]"
                                                            value="<?php echo $p_id_2; ?>" />
                                                        <input type="number" id="cmp_input"
                                                            class="form-control p-0 text-center" name="cmp[]"
                                                            placeholder="0" min="0" step="any"
                                                            value="<?php echo $cmp; ?>">
                        ...
                        <td class="td-padding">
                            <table class="table table-bordered">
                                <tbody>
                                    <tr>
                                        <td colspan="">-</td>
                                        <td class="total_cmp_{{ $l_id }} new_total_daily_cmp">total_cmp</td>
                                    </tr>
                                    @for ($j = 0; $j < count($daily_report_product_decode); $j++)
                                        @php
                                            $l_id_2 = $daily_report_product_decode[$j]['l_id'];
                                            ...
                                            $p_id_2 = $daily_report_product_decode[$j]['p_detail_id']; @endphp @if ($l_id_2 == $l_id)
                                                <tr>
                                                    <td class="h_bal_input">
                                                        ...
                                                        <input type="number" id="h_bal_val_input"
                                                            class="form-control p-0 text-center"
                                                            name="h_balance_val_input[]" placeholder="0" min="0"
                                                            step="any" value="<?php echo $h_balance; ?>">
                                                        <input type="hidden" id="h_bal_p_id_input" name="p_id_input[]"
                                                            value="<?php echo $p_id_2; ?>" />
                                                    </td>
                                                </tr>
                            ...
                            <table class="m-auto text-center w-100 table table-bordered custom-table-border-color">
                                ...
                                @else
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="total_m_power_{{ $l_id }}" colspan="2"
                                                id="total_m_power"></td>
                                        </tr>
                                        <tr>
                                            <td class="actual_m_power_value_{{ $l_id }}">
                                        ...
                                        <tr>
                                            <td class="total_actual_m_power_{{ $l_id }} total_actual_m_power"
                                                colspan="2" id="total_actual_m_power"></td>
                                        </tr>
                                    </tbody>
                                @endif
                        ...
                        @for ($k = 0; $k < count($daily_report_decode); $k++)
                            @php$l_id_2 = $daily_report_decode[$k]['l_id'];
                                                                                                                                            $total_time = (int) $daily_report_decode[$k]['total_time']; @endphp ?> ?> ?> ?> @if ($l_id_2 == $l_id)
                                <td class="total_time_{{ $l_id_2 }}"> {{ $total_time }} </td>
                            @endif
                        @endfor --}}
                        ...
                        <td class="cmp_hr_{{ $l_id }}"></td>
                        <td class="cmp_hr_ps_{{ $l_id }} new_cmp_hr_ps"></td>
                        <td class="note_input">
                            @if ($edit_status)
                                <input type="hidden" id="note_l_id_input" name="l_id[]"
                                    value="<?php echo $l_id; ?>" />
                                <input type="hidden" id="note_a_id_input" name="a_id[]"
                                    value="<?php echo $assign_id_2; ?>" />
                                <input type="hidden" id="note_date_input" name="date_input[]"
                                    value="<?php echo $date; ?>" />
                                <textarea class="form-control note" name="note[]" placeholder="Note" id="note_val_input" maxlength="150"><?php echo $remark; ?></textarea>
                            ...
                            <tbody id="myTable" class="report_tbl_2">
                                @for ($i = 0; $i < count($daily_report_decode); $i++)
                                    ...
                                    $remark = $daily_report_decode[$i]['remark']; @endphp <tr>
                                            ...
                                            <table class="m-auto text-center table table-bordered custom-table-border-color">
                                                @if ($edit_status)
                                                    <tbody class="man_power_input">
                                                        ...
                                                        <input type="hidden" id="man_target_a_id_input"
                                                            name="man_target_a_id[]" value="<?php echo $assign_id_2; ?>" />
                                                        <input type="hidden" id="man_target_date_input"
                                                            name="date_input[]" value="<?php echo $date; ?>" />
                                                    ...
                                                    <tbody>
                                                        ...
                                                        @for ($j = 0; $j < count($daily_report_product_decode); $j++)
                                                            ...
                                                            @if ($l_id_2 == $l_id)
                                                                <tr>
                                                                    <td class="inline_input">
                                                                        <input type="hidden" id="inline_l_id_input"
                                                                            name="inline_l_id[]"
                                                                            value="<?php echo $l_id; ?>" />
                                                                        <input type="hidden" id="inline_a_id_input"
                                                                            name="inline_a_id[]"
                                                                            value="<?php echo $assign_id_2; ?>" />
                                                                        <input type="hidden" id="inline_date_input"
                                                                            name="date_input[]"
                                                                            value="<?php echo $date; ?>" />
                                                                        <input type="number" id="inline_val_input"
                                                                            class="form-control p-0 text-center"
                                                                            name="inline_val_input[]"
                                                                            value="<?php echo $inline_2; ?>">
                                                                        <input type="hidden" id="inline_p_id_input"
                                                                            name="inline_p_id_input[]"
                                                                            value="<?php echo $p_id_2; ?>" />
                                                    ...
                                                    <tbody>
                                                        ...
                                                        @for ($j = 0; $j < count($daily_report_product_decode); $j++)
                                                            ...
                                                            @endphp @if ($l_id_2 == $l_id)
                                                                <tr>
                                                                    <td class="h_over_input">
                                                                        <input type="hidden" id="handover_l_id_input"
                                                                            name="l_id[]" value="<?php echo $l_id; ?>" />
                                                                        <input type="hidden" id="handover_a_id_input"
                                                                            name="a_id[]" value="<?php echo $assign_id_2; ?>" />
                                                                        <input type="hidden" id="handover_date_input"
                                                                            name="date_input[]"
                                                                            value="<?php echo $date; ?>" />
                                                                        <input type="number" id="handover_val_input"
                                                                            class="form-control p-0 text-center"
                                                                            name="handover_val_input[]" placeholder="0"
                                                                            min="0" step="any"
                                                                            value="<?php echo $h_over_input; ?>">
                                                                        <input type="hidden" id="handover_p_id_input"
                                                                            name="p_id_input[]"
                                                                            value="<?php echo $p_id_2; ?>" />
                                                                    </td>
                                                                </tr>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        @for ($j = 0; $j < count($daily_report_product_decode); $j++)
                                                            ...
                                                            @if ($l_id_2 == $l_id)
                                                                <tr>
                                                                    <td class="h_bal_input">
                                                                        <input type="hidden" id="h_bal_l_id_input"
                                                                            name="l_id[]" value="<?php echo $l_id; ?>" />
                                                                        <input type="hidden" id="h_bal_a_id_input"
                                                                            name="a_id[]" value="<?php echo $assign_id_2; ?>" />
                                                                        <input type="hidden" id="h_bal_date_input"
                                                                            name="date_input[]"
                                                                            value="<?php echo $date; ?>" />
                                                                        <input type="number" id="h_bal_val_input"
                                                                            class="form-control p-0 text-center"
                                                                            name="h_balance_val_input[]" placeholder="0"
                                                                            min="0" step="any"
                                                                            value="<?php echo $h_balance; ?>">
                                                                        <input type="hidden" id="h_bal_p_id_input"
                                                                            name="p_id_input[]"
                                                                            value="<?php echo $p_id_2; ?>" />
                                                                    </td>
                                                                </tr>
                                        ...
                                        <td>
                                            <table
                                                class="m-auto text-center w-100 table table-bordered custom-table-border-color">
                                                @if ($edit_status)
                                                    <tbody class="m_power_input_2">
                                                        <input type="hidden" id="m_power_l_id_input_2" name="l_id[]"
                                                            value="<?php echo $l_id; ?>" />
                                                        <input type="hidden" id="m_power_a_id_input_2" name="a_id[]"
                                                            value="<?php echo $assign_id_2; ?>" />
                                                        <input type="hidden" id="m_power_date_input_2"
                                                            name="date_input[]" value="<?php echo $date; ?>" />
                                                        <tr>
                                                            <td>
                                                                <input type="number" id="m_power_value_2"
                                                                    class="form-control p-0 text-center"
                                                                    name="m_power_value_2[]" placeholder="0"
                                                                    min="0" step="any"
                                                                    value="<?php echo $m_power; ?>">
                                                            </td>
                                                            <td>
                                                                <input type="number" id="hp_value_2"
                                                                    class="form-control p-0 text-center" name="hp_value_2[]"
                                                                    placeholder="0" min="0" step="any"
                                                                    value="<?php echo $hp; ?>">
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <input type="number" id="actual_m_power_value_2"
                                                                    class="form-control p-0 text-center"
                                                                    name="actual_m_power_value[]" placeholder="0"
                                                                    min="0" step="any"
                                                                    value="<?php echo $actual_m_power; ?>">
                                                            </td>
                                                            <td>
                                                                <input type="number" id="actual_hp_value_2"
                                                                    class="form-control p-0 text-center"
                                                                    name="actual_hp_value_2[]" placeholder="0"
                                                                    min="0" step="any"
                                                                    value="<?php echo $actual_hp; ?>">
                                                            </td>
                                                        </tr>
                                                ...
                                                @else
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td class="total_actual_m_power_{{ $l_id }}"
                                                                colspan="2" id="total_actual_m_power"></td>
                                                        </tr>
                                                    </tbody>
                                                @endif
    ...
    <script>
        var tableToExcel = (function() {
            ...
            var uri = 'data:application/vnd.ms-excel;base64,',
                template =
                '<html xmlns:o="urn:schemas-microsoft-com:office:office" xmlns:x="urn:schemas-microsoft-com:office:excel" xmlns="https://www.w3.org/TR/REC-html40"><head></head><body><table border="1">{table}</table></body></html>',
                base64 = function(s) {
