<div class="wrapper d-flex align-items-stretch">
        ...
        <div class="">
            <div class="">
                <button onclick="toggle_div_fun('sectiontohide');"
                    ...
                    <i class="fas fa-user-circle fa-3x"></i><span style="word-break: break-word;"> User </span>
    ...
    <nav id="sidebar" class="d-flex flex-column flex-shrink-0 justify-content-between active">
        <div class="p-4">
            <div class="sidebar-header">
                <a href="#"><img src="{{asset('img/logo_2.png')}}" class="img-fluid rounded-3" alt="Company Logo"
