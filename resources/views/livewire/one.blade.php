...
<div class='present_head' style=''>
            <h3 style="font-size: 22px;padding: 2px 0 0 0;" class="text-light">
                Present</h3></div>
...
{{-- kmk --}}
                <tr id="tcurrent1">
                            <td style="height: 35.5px;background: #E9E9E9;"><span
                                    class="text-light">
                ...
                <tr id="tcurrent2"><td></td></tr>
                        ...
                        <tr class="text-light" id="tcurrent3">
                            <td style="height: 36.6px;background:#E9E9E9;" class="">
                                <span
                                    class=""></span>
                            </td>
                        </tr>
                        ...
                        <tr class="text-light" id="tcurrent5">
                            <td style="height: 40.5px;min-width:120px;background:#2980B9;"
                                class="">
                                <span class=""></span>
                            </td>
                        </tr>
            ...
            class="w-100 text-center table m-0 totalTable table-bordered table-sm border-white right_table">
                    <h3 class="rank_heading text-light" style="font-size: 22px;padding: 2px 0 0 0;">
                    Daily</h3>
                        <tr class="text-dark">
            ...
            if ($t_line->row_num == 1) {
                foreach ($top_line as $t_line2) {
                    if ($t_line2->row_num == 2 || $t_line2->row_num == 3 || $t_line2->row_num == 4) {
                        ...
                        echo "
            <div class='bottom_rank' style='padding: 3px 0 0 0;display: flex;margin:auto;width:300px;position: relative;top:-215px;margin-left:460px;height:28px;
            border: solid 1px;'>" .
                            "<div style='display: flex;min-width:200px;margin-right:5px;'>" .
                ...
                "
                <h3 style='font-weight: bold;font-size:17px;margin-left:2px;color:#0070C0;
                ...
                <h3 style='font-weight: bold;font-size:17px;color:#0070C0;
                    ...
                    "<h3 style='
                                    ...
                                    font-size:14px;color:black;font-weight:900;padding: 5px 0 0 7px;'>" . "-" .
                                    $t_line->diff_target_percent-$t_line2->diff_target_percent
                                . "%" .
                                "</h3> &nbsp;" .

                            "<div style='margin-left:10px;display:flex;position: relative;top:1px;right:27px;
                            padding:0 0 0 0;min-width:40px;height:20px;background:#ff0000;text-align: center;
